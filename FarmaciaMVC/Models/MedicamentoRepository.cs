...
namespace FarmaciaMVC.Models
{
    public class MedicamentoRepository : Repository
    {
        public void Cadastro(Medicamento m)
        {
            ...
            string sql = "INSERT INTO Medicamento (nome, descricao, valor, dosagem, qtdEstoque) VALUE (@nome, @descricao, @valor, @dosagem, @qtdEstoque)";
        ...
        public List<Medicamento> Lista(int id)
        {
            ...
            while (reader.Read())
            {
                ...
                if (!reader.IsDBNull(reader.GetOrdinal("qtdEstoque")))
                    medicamento.QtdEstoque = reader.GetInt32("dqtdEstoque");
